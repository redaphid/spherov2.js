...
const factory = (seq) => {
    ...
    const gen = (deviceId) => (part) => encoder_1.encode(Object.assign(Object.assign({}, part), { commandFlags: [types_1.Flags.requestsResponse, types_1.Flags.resetsInactivityTimeout], deviceId, sequenceNumber: getSequence() }));
    return {
